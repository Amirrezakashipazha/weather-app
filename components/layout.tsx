...
const Layout = ({ children }: { children: ReactNode }) => {
  ...
  const [selectedCountry, setSelectedCountry] =
    useState<CountrySummaryInformation>();
            ...
            <div className="">
              <div className="flex items-center justify-center gap-4 ![&>div>lable]:after-none">
                <div className="select-search-countries [&>div>ul]:bg-card-800 relative">
                  {
                    <Select
                      ...
                      className="gap-2 bg-card-800 min-w-[333px] border-none rounded-[999px] text-white pt-8 [&>span]:ml-2"
                    >
                      <div
                        className=" sticky top-0  right-0 after:absolute after:-top-[12px] after:right-0 after:w-full after:h-3 after:bg-card-800
                     before:absolute before:bottom-0 before:right-0 before:w-full before:h-[8px] before:bg-card-800"
                      >
                        <input
                          className="
                     
                    w-full h-8 border text-white border-gray-600 rounded-md px-3 mb-2 bg-card-800"
                          ref={inputCountries}
                          onKeyUp={(e) =>
                ...
                <Menu open={openMenu} handler={setOpenMenu}>
                  <MenuHandler>
                    <div
                      className="cursor-pointer h-12 min-w-12 flex items-center gap-2 "
