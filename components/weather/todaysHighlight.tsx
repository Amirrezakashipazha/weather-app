...
const TodaysHighlight = ({ data }: { data?: weather }) => {
  ...
  useEffect(() => {
    ...
    if (dataModelHourly) {
      const index = dataModelHourly.time.findIndex(
        (item) => item === formatted
      );
      if (index !== -1) {
        setNowIndex(index);
      ...
      {data ? (
        <div className="mt-2 h-[calc(100%-2.5rem)] w-[calc(100%-2rem)] grid grid-cols-[30%,30%,40%] grid-rows-2 gap-4">
          <div className="bg-card-500 rounded-lg p-3 h-full flex flex-col justify-between items-end">
            <div className="flex justify-end w-full gap-1 items-center">
              <Image
                src="/assets/images/weather/solar_wind-linear.svg"
                width={24}
                height={24}
                alt=""
              />
            ...
            <p className="text-2xl">
              {dataModelHourly?.wind_speed_10m[nowIndex]}
          ...
          <div className="bg-card-500 rounded-lg p-3 h-full flex flex-col justify-between items-end">
            <div className="flex justify-end w-full gap-1 items-center">
              <Image
                src="/assets/images/weather/carbon_humidity.svg"
                width={24}
                height={24}
                alt=""
              />
            ...
            <p className="text-2xl">
              {dataModel?.relative_humidity_2m}
            ...
            <span>
              {dataModel &&
                (dataModel?.relative_humidity_2m < 30
                  ? "Humidity is too low"
          ...
          <div className="bg-card-500 rounded-lg p-3">
            <div className="flex items-center justify-between h-full w-full">
              <Image
                src="/assets/images/weather/sunrise.svg"
                width={64}
                height={64}
                alt=""
              />
              <div className="flex flex-col items-start justify-center gap-2">
                ...
                <p className="text-2xl font-semibold">
                  {dataModelDaily?.sunrise[0]?.split("T")[1]} <span>AM</span>
                </p>
              </div>
            </div>
          </div>
          <div className="bg-card-500 rounded-lg p-3 h-full flex flex-col justify-between items-end">
            <div className="flex justify-end w-full gap-1 items-center">
              <Image
                src="/assets/images/weather/hugeicons_uv-02.svg"
                width={24}
                height={24}
                alt=""
              />
          ...
          <div className="bg-card-500 rounded-lg p-3 h-full flex flex-col justify-between items-end">
            <div className="flex justify-end w-full gap-1 items-center">
              <Image
                src="/assets/images/weather/ri_eye-line.svg"
                width={24}
                height={24}
                alt=""
              />
            ...
            <p className="text-2xl">
              {dataModelHourly?.visibility[nowIndex]}
          ...
          <div className="bg-card-500 rounded-lg p-3">
            <div className="flex items-center justify-between h-full w-full">
              <Image
                src="/assets/images/weather/sunset.svg"
                width={64}
                height={64}
                alt=""
              />
              <div className="flex flex-col items-start justify-center gap-2">
                <p>Sunset</p>
                <p className="text-2xl font-semibold">
                  {dataModelDaily?.sunset[0]?.split("T")[1]} <span>PM</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-2 h-[calc(100%-2.5rem)] w-[calc(100%-2rem)] grid grid-cols-[30%,30%,40%] grid-rows-2 gap-4">
          {Array.from({ length: 6 }).map((item, index) => (
            <SkeletonSimpleCard key={index} className="min-h-min max-w-none" />
          ))}
        </div>
      )}
    </div>
