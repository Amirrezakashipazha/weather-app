        ...
        <div className="bg-card-800 rounded-2xl p-4 max-h-[50vh] text-white relative">
            <div className=" w-full flex items-start justify-between">
                <Button className="py-1 px-4 rounded-xl bg-card-500 flex justify-between items-center font-normal">
                    <Image src="/assets/images/weather/location.svg" width={24} height={24} alt="location" className='mr-2' />
                    <p>
                        Dhaka, Bangladesh
                    </p>
                </Button>
            ...
            <div className="">
                ...
                <div className="absolute bottom-4 right-4 flex flex-col gap-11">
                    <div className="flex flex-col items-end">
                        <p className='font-medium text-4xl'>{Math.round(dataModelDaily?.temperature_2m_max[0] || 0)}{unitDataModelDaily?.temperature_2m_max}</p>
                        <p className='font-medium text-2xl text-gray-500'>/{Math.round(dataModelDaily?.temperature_2m_min[0] || 0)}{unitDataModelDaily?.temperature_2m_min}</p>
                    </div>
                    <div className="flex flex-col gap-2">
                        <p>Heavy Rain</p>
                        <span className='text-base'>Feels like {dataModel?.apparent_temperature || 0}°</span>
                    </div>
                </div>
            </div>
        </div>
