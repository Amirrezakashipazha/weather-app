...
export default function Home() {
  ...
  return (
    <div className="grid w-[calc(100%-1rem)] h-full grid-cols-[45%,55%] gap-4">
      <div className="grid h-[calc(100%-1rem)] gap-4" style={{ gridTemplateRows: "45% 55%" }}>
    ...
    <Menu>
      ...
      <div className="grid h-[calc(100%-1rem)] gap-4" style={{ gridTemplateRows: "55% 45%" }}>
        <div className="bg-card-800 rounded-2xl p-4">
        ...
        <h3 className='text-xl font-medium text-white'>10 Day Forecast</h3>
          <div className="mt-3 w-[calc(100%-2rem)] flex gap-4 h-[calc(100%-2.5rem)]">
          <div className="bg-card-500 rounded-2xl w-[104px] h-full"></div>
          <div className="bg-card-500 rounded-2xl w-[104px] h-full"></div>
          <div className="bg-card-500 rounded-2xl w-[104px] h-full"></div>
